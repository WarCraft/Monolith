...
class SpigotBlockOrientationMapper {
  ...
  def map(orientation: SpigotBlockOrientation): BlockOrientation = orientation match {
  ...
  def map(orientation: BlockOrientation): SpigotBlockOrientation = orientation match {
