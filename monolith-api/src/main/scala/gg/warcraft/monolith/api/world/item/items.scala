...
final case class ClayBlock(data: ItemData) extends Item {
  ...
  def this() = this(ItemData("Clay Block")) // TODO technically this is also called Clay ingame
}
