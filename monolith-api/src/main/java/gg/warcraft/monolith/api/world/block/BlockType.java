...
public enum BlockType {
    ...
    LEVER_BOTTOM_OFF_EAST("minecraft:lever", 69),
    LEVER_EAST_OFF("minecraft:lever", 69, 1),
    LEVER_WEST_OFF("minecraft:lever", 69, 2),
    LEVER_SOUTH_OFF("minecraft:lever", 69, 3),
    LEVER_NORTH_OFF("minecraft:lever", 69, 4),
    LEVER_TOP_OFF_SOUTH("minecraft:lever", 69, 5),
    LEVER_TOP_OFF_EAST("minecraft:lever", 69, 6),
    LEVER_BOTTOM_OFF_SOUTH("minecraft:lever", 69, 7),
    LEVER_BOTTOM_ON_WEST("minecraft:lever", 69, 8),
    LEVER_EAST_ON("minecraft:lever", 69, 9),
    LEVER_WEST_ON("minecraft:lever", 69, 10),
    LEVER_SOUTH_ON("minecraft:lever", 69, 11),
    LEVER_NORTH_ON("minecraft:lever", 69, 12),
    LEVER_TOP_ON_NORTH("minecraft:lever", 69, 13),
    LEVER_TOP_ON_WEST("minecraft:lever", 69, 14),
    LEVER_BOTTOM_ON_NORTH("minecraft:lever", 69, 15),
